...
<html>
<head>
    <title>Booking <%= booking.getTitle() %>
    </title>
    <jsp:include page="head.jsp"/>
    <script>const bookingID = <%= booking.getBookingid() %>
    </script>
...
<div class="row">
    ...
    <div class="col-md-4">
        <h1 class="booking-information-header"><%= booking.getTitle() %>
        </h1>
        ...
        <div class="booking-information-field">
            ...
            <ul>
                ...
                <li>
                    <%= user.getName() %>
                    <span onclick="removeParticipant(<%=booking.getBookingid()%>, <%=user.getUserid()%>)"
                          class="fa-span remove-participant">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content alert alert-success">
                ...
                <div class="modal-footer">
                    <button onclick="redirectToAllBookings()" type="button" class="btn btn-primary">Go To Bookings
                    </button>
                </div>
            </div>
        </div>

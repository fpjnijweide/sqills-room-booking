...
<div class="blur-container">
    ...
    <div class="right-container">
        <div class="centered-container">
            <div class="centered-text" id="room-name"><%= request.getAttribute("roomName") %>
            </div>
            <div class="centered-text" id="time">13:31</div>
            <div class="centered-text" id="availability">UNAVAILABLE</div>
            <div id="book-button" class="centered-button" onclick="blurBackground(); showCreationPopUp();">Advanced
                Booking
            </div>
...
<div id="make-booking-overlay" class="hidden">
    <div class="close" onclick="hideCreationPopUp(); unblurBackground();"><i class="fa fa-close" aria-hidden="true"></i>
    </div>
    ...
    <div class="vertical-group">
        <label>Title: </label><input onchange="validateTitle(this.value);" class="text-input" type="text"
                                     id="booking-title" value="Booking Title (Optional)">
    </div>

    <div class="vertical-group">
        <label>Email: </label><input onchange="validateEmail(this.value);" class="text-input" type="text"
                                     id="booking-email" value="Email (Optional)">
    </div>

    <div class="vertical-group">
        <label>Duration: </label>
        <div class="duration-display" id="booking-duration">15 min</div>
        <input onchange="validateDuration(this.value); updateDuration(this.value)" type="range" min="15" max="120"
               step="5" value="15" class="custom-range form-control-range" id="slider">
    </div>

    <div class="vertical-group"><label>Private Meeting: </label><input class="" type="checkbox" id="booking-checkbox">
    </div>

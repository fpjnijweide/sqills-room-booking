...
create function get_participants_of_booking(booking_id int) returns table
                                                                    (
                                                                        user_id       int,
                                                                        name          text,
                                                                        email         text,
...
$$
    language sql;
delete
from sqills.participants;
delete
from sqills.booking_recurring;
delete
from sqills.booking;


select *
from sqills.google_calendar_sync